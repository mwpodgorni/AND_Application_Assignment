...
import com.example.myproject.Stories.model.Page;
import com.example.myproject.Stories.model.Stories;
import com.example.myproject.Stories.model.Story;
...
public class StoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, name);
        stories= new Stories();
        stories.initializePages(storyNumber);
        story = stories.getStory(storyNumber);
        loadPage(0);
    }
